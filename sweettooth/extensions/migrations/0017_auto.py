...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'ExtensionPopularityItem', fields ['date']
        db.create_index('extensions_extensionpopularityitem', ['date'])

        # Adding index on 'ExtensionPopularityItem', fields ['offset']
        db.create_index('extensions_extensionpopularityitem', ['offset'])


    def backwards(self, orm):
        
        # Removing index on 'ExtensionPopularityItem', fields ['offset']
        db.delete_index('extensions_extensionpopularityitem', ['offset'])

        # Removing index on 'ExtensionPopularityItem', fields ['date']
        db.delete_index('extensions_extensionpopularityitem', ['date'])
    ...
    models = {
        ...
        'extensions.extensionpopularityitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'})
        },
