...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Extension.icon'
        db.add_column('extensions_extension', 'icon', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Extension.icon'
        db.delete_column('extensions_extension', 'icon')
