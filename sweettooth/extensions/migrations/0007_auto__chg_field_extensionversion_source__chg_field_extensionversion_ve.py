...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ExtensionVersion.source'
        db.alter_column('extensions_extensionversion', 'source', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'ExtensionVersion.version'
        db.alter_column('extensions_extensionversion', 'version', self.gf('django.db.models.fields.IntegerField')(max_length=223))
