...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChangeStatusLog'
        db.create_table('review_changestatuslog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('newstatus', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(related_name='status_log', to=orm['extensions.ExtensionVersion'])),
        ))
        db.send_create_signal('review', ['ChangeStatusLog'])


    def backwards(self, orm):
        
        # Deleting model 'ChangeStatusLog'
        db.delete_table('review_changestatuslog')
