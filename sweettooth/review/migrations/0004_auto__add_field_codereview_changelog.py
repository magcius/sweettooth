...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CodeReview.changelog'
        db.add_column('review_codereview', 'changelog', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['review.ChangeStatusLog'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CodeReview.changelog'
        db.delete_column('review_codereview', 'changelog_id')
