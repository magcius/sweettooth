...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CodeReview.new_status'
        db.add_column('review_codereview', 'new_status', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'CodeReview.auto'
        db.add_column('review_codereview', 'auto', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CodeReview.new_status'
        db.delete_column('review_codereview', 'new_status')

        # Deleting field 'CodeReview.auto'
        db.delete_column('review_codereview', 'auto')
    ...
    models = {
        ...
        'review.codereview': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_status': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
