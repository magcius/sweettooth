...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ErrorReport.errors'
        db.delete_column('errorreports_errorreport', 'errors')


    def backwards(self, orm):
        
        # Adding field 'ErrorReport.errors'
        db.add_column('errorreports_errorreport', 'errors', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
